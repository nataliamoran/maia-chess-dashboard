...
@app.post("/api/students", response_description="Add new student", response_model=StudentModel)
...
@app.delete("/api/students/{id}", response_description="Delete a student")
